    ...
    async function getList() {
        ...
        res.data['data'].forEach(function(item, index) {
            let row = `<tr>
                        ...
                        <td style="text-align: center; "><div class="isCompliteWrapper"><i onclick="isComplete(${item['id']}, '${item['title']}')""  data-id="${item['id']}" data-title="${item['title']}" id="completeBtn" class="bi bi-patch-check-fill"></i></div></td>
                        <td>
