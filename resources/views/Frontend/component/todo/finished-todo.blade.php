...
<script>
    ...
    async function getList() {
        ...
        showLoader();
        let res = await axios.get("/complete-todo");
        hideLoader();
        ...
        res.data['data'].forEach(function(item, index) {
            let row = `<tr>
                        ...
                        <td style="text-align: center; "><div class="isCompliteWrapper"><i  data-id="${item['id']}" data-title="${item['title']}" id="completeBtn" class="bi bi-check2-circle text-success"></i></div></td>
                        <td>
